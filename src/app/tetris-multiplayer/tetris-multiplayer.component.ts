...
export class TetrisMultiplayerComponent {
  ...
  public tetrisManager: any;
  public tetrisLocal: any;
  ...
  constructor() { 
    ...
    setTimeout(() => {
      ...
      this.tetrisLocal = this.tetrisManager.createPlayer();
      this.connectionManager = new ConnectionManager(this.tetrisManager);


      this.tetrisLocal.element.classList.add('local');
      this.tetrisLocal.run();
  ...
  keyListener = (event) => {
      [
          ...
          const player = this.tetrisLocal.player;
...
class Player {
  ...
  public DROP_SLOW: number;
  public DROP_FAST: number;
  public events: any;
  public tetris: any;
  public arena: any;
  public dropCounter: number;
...
class TetrisManager {
  ...
  createPlayer() {
    const element = this.document.importNode(this.template, true).children[0];

    console.log(element);
    var tetris: any = new Tetris(element);
